/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 616cbe27ef86d1ecb4f7453512dbc197)
...
declare namespace Cloudflare {
	interface DevelopmentEnv {
		...
		PUBLIC_API_TITLE: string;
		PUBLIC_API_VERSION: string;
		PUBLIC_API_DESCRIPTION: string;
	}
	interface Env {
		MAIN_KV: KVNamespace;
		MAIN_R2: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_TRUSTED_ORIGINS" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "PUBLIC_API_TITLE" | "PUBLIC_API_VERSION" | "PUBLIC_API_DESCRIPTION">> {}
}
