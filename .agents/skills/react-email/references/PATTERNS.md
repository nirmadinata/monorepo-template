            ...
            <Tailwind config={{ presets: [pixelBasedPreset] }}>
                ...
                <Body className="bg-gray-100 font-sans">
                    ...
                    <Container className="mx-auto py-10 px-5 max-w-xl bg-white">
                        ...
                        <Text className="text-base leading-7 text-gray-800 my-4">
                            Click the button below to reset your password. This
    ...
    return (
        <Html lang="en">
            <Tailwind config={{ presets: [pixelBasedPreset] }}>
                ...
                <Body className="bg-gray-100 font-sans">
                    <Preview>
                        Order #{orderNumber} confirmed - Thank you for your
                        purchase!
                    </Preview>
                    <Container className="mx-auto py-10 px-5 max-w-xl">
                        ...
                        <Text className="text-sm text-gray-500 mt-8">
                            Questions about your order? Reply to this email and
                            we'll help you out.
                        </Text>
                    </Container>
                </Body>
            ...
            <Tailwind config={{ presets: [pixelBasedPreset] }}>
                ...
                <Body className="bg-gray-100 font-mono">
                    ...
                    <Container className="mx-auto max-w-xl bg-white border border-solid border-gray-200 rounded overflow-hidden">
                        <Section
                            className={`h-1 w-full ${severityColors[severity]}`}
                        />
        ...
        <Html lang="en">
            <Tailwind config={{ presets: [pixelBasedPreset] }}>
                ...
                <Body className="bg-white font-sans">
                    <Preview>
                        Your weekly roundup of the latest articles
                    </Preview>
                    <Container className="mx-auto max-w-xl">
                        ...
                        <Text className="text-base leading-6 text-gray-500 mx-5 mb-6 text-center">
                            Here are the top articles from this week. Enjoy your
                            reading!
                        </Text>
                        ...
                        {articles.slice(1, 5).length > 0 && (
                            <>
                                ...
                                {Array.from({
                                    length: Math.ceil(
                                        articles.slice(1, 5).length / 2
                                    ),
                                }).map((_, rowIndex) => {
                                    const leftArticle =
                                        articles[1 + rowIndex * 2];
                                    const rightArticle =
                                        articles[2 + rowIndex * 2];
...
Newsletter.PreviewProps = {
    articles: [
        ...
        },
        {
            ...
            excerpt:
                "A deep dive into React Server Components and their benefits.",
        ...
        },
        {
            ...
            excerpt:
                "Best practices for creating inclusive digital experiences.",
            image: "https://via.placeholder.com/280x140",
            ...
            <Tailwind config={{ presets: [pixelBasedPreset] }}>
                ...
                <Body className="bg-gray-100 font-sans">
                    ...
                    <Container className="mx-auto py-10 px-5 max-w-xl bg-white">
                        ...
                        <Text className="text-base leading-7 text-gray-800 my-4">
                            <strong>{inviterName}</strong> ({inviterEmail}) has
                        ...
                        <Text className="text-base leading-7 text-gray-800 my-4">
                            Click the button below to accept the invitation and
                            get started.
                        </Text>
